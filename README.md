...
Галерея будет добавляться по мере подготовки обезличенных снимков интерфейса. На скриншотах не должны присутствовать рабочие URL подписок, UUID, ключи, токены, внутренние адреса серверов и личные уведомления.

Правила и утверждённый список экранов находятся в [разделе скриншотов](docs/screenshots/README.md).
...
Не публикуйте конфигурацию, резервную копию или журнал без предварительной проверки. Подробные правила находятся в [SECURITY.md](SECURITY.md).
